...
Setting VPS on [cPouta](https://research.csc.fi/service/cpouta-community-cloud-service/) and [Azure](https://azure.microsoft.com/en-gb).

### Week 2

Chose answering questions, since other options had technical issues or required knowledge I don't yet have.
...
Simple dynamic [website](https://pilvipalvelut-60708.web.app) using Google Firebase.
...
Did the six tutorial to Kubernetes from [here](https://kubernetes.io/docs/tutorials/kubernetes-basics/).
...
I used Gemini coding agent to create a simple game without me writing a single line of code. [Source](https://github.com/Ard3J/Pilvipalvelut-Agent-Coding) and [game](https://ard3j.github.io/Pilvipalvelut-Agent-Coding/).
